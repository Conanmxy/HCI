...
public class NewsFragment extends Fragment {
    ...
    StringBuilder Url=new StringBuilder("http://ent.ifeng.com/listpage/6/1/list.shtml");
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                for(int i=0;i<results.size();i=i+2)
                {
                    ...
                    if(i%5==0)
                    {
                        String ImageSrc="n"+String.valueOf(((i/5)%5));
                        int ImageId=getResources().getIdentifier(ImageSrc,"drawable",getContext().getPackageName());
                        news.setImageSrc(ImageId);
                    }
                    else news.setImageSrc(65535);
//                    String ImageSrc="n"+String.valueOf(i%5);
//                    int ImageId=getResources().getIdentifier(ImageSrc,"drawable",getContext().getPackageName());
//                    news.setImageSrc(ImageId);
    ...
    private class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder>
    {
        ...
        class ViewHolder extends RecyclerView.ViewHolder
        {
            ...
            public ViewHolder(View view)
            {
                ...
                newsImage=(ImageView)view.findViewById(R.id.imageview1);
            }
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position)
        {
            ...
            //holder.newsImage.setImageResource(news.getImageSrc());
            if(news.getImageSrc()!=65535)
            {
                holder.newsImage.setImageResource(news.getImageSrc());
            }
            else holder.newsImage.getLayoutParams().height=0;
        }
