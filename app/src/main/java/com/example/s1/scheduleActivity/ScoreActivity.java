...
public class ScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton titleLeft=(ImageButton)findViewById(R.id.title_left);
        ...
        ImageButton titleRight=(ImageButton)findViewById(R.id.title_right);
        ...
        if(suserName.equals(userName) && false)//加载缓存
        {
